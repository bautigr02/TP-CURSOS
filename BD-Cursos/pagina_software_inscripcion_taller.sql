...
CREATE TABLE `inscripcion_taller` (
  ...
  `estado` int NOT NULL,
  `nota_taller` int DEFAULT NULL,
  PRIMARY KEY (`idcurso`,`idtaller`,`dni`),
  KEY `fk_dni` (`dni`),
  KEY `fk_idtaller` (`idtaller`),
  CONSTRAINT `fk_dni` FOREIGN KEY (`dni`) REFERENCES `alumno` (`dni`),
  CONSTRAINT `fk_idcurso_inscripcion_taller` FOREIGN KEY (`idcurso`) REFERENCES `curso` (`idcurso`),
  CONSTRAINT `fk_idtaller` FOREIGN KEY (`idtaller`) REFERENCES `taller` (`idtaller`)
...
INSERT INTO `inscripcion_taller` VALUES (1,1,11000222,'2025-03-03',3,2),(1,1,44114310,'2025-01-01',1,8);
